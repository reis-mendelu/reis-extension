...
// Split out of createSuggestionsSlice.test.ts to keep files under the
// 200-line convention limit — these cover concurrent/racing resync
// scenarios specifically, the core slice behavior lives in the other file.
