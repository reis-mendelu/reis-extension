...
export const ERASMUS_COUNTRIES: ErasmusCountry[] = [
  ...
  { id: '203', alpha2: 'CZ', cs: 'Česko', en: 'Czechia', file: '' },
  ...
  { id: '352', alpha2: 'IS', cs: 'Island', en: 'Iceland', file: '' },
  ...
  { id: '438', alpha2: 'LI', cs: 'Lichtenštejnsko', en: 'Liechtenstein', file: '' },
  { id: '440', alpha2: 'LT', cs: 'Litva', en: 'Lithuania', file: 'country-440-study.json' },
  { id: '442', alpha2: 'LU', cs: 'Lucembursko', en: 'Luxembourg', file: '' },
  { id: '470', alpha2: 'MT', cs: 'Malta', en: 'Malta', file: '' },
  { id: '528', alpha2: 'NL', cs: 'Nizozemsko', en: 'Netherlands', file: 'country-528-study.json' },
  { id: '807', alpha2: 'MK', cs: 'Severní Makedonie', en: 'North Macedonia', file: '' },
