...
export const Messages = {
    ...
    actionResult: (id: string, s: boolean, d?: unknown, e?: string, demoMode?: boolean): T.ActionResultMessage => ({ type: 'REIS_ACTION_RESULT', id, success: s, data: d, error: e, demoMode }),
