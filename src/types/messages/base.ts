...
export interface SyncedData { schedule?: any; exams?: any; subjects?: any; files?: any; assessments?: any; syllabuses?: any; studyProgram?: any; isSyncing?: boolean; lastSync: number; error?: string; }
...
export interface ActionRequestMessage { type: 'REIS_ACTION'; id: string; action: ActionType; payload: any; }

export type IframeToContentMessage = ReadyMessage | RequestDataMessage | FetchRequestMessage | ActionRequestMessage;

export interface DataResponseMessage { type: 'REIS_DATA'; dataType: DataRequestType; data: any; error?: string; }
export interface FetchResultMessage { type: 'REIS_FETCH_RESULT'; id: string; success: boolean; data?: string; error?: string; }
export interface ActionResultMessage { type: 'REIS_ACTION_RESULT'; id: string; success: boolean; data?: any; error?: string; }
