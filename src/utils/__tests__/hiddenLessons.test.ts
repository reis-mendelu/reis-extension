...
describe('isLessonHidden', () => {
  ...
  it('is hidden when the course is hidden with a matching type (seminar)', () => {
    ...
    expect(
      isLessonHidden(
        l,
        hidden({ courses: [{ courseCode: 'EBC-MAN', courseName: 'Management', type: 'seminar' }] })
      )
    ).toBe(true);
  });
  ...
  it('is hidden when the course is hidden with a matching type (lecture)', () => {
    ...
    expect(
      isLessonHidden(
        l,
        hidden({ courses: [{ courseCode: 'EBC-MAN', courseName: 'Management', type: 'lecture' }] })
      )
    ).toBe(true);
  });
  ...
  it('is hidden when the course is hidden with type "all", regardless of lesson type', () => {
    ...
    expect(
      isLessonHidden(
        l,
        hidden({ courses: [{ courseCode: 'EBC-MAN', courseName: 'Management', type: 'all' }] })
      )
    ).toBe(true);
  });
  ...
  it('is NOT hidden when the course code does not match', () => {
    ...
    expect(
      isLessonHidden(
        l,
        hidden({ courses: [{ courseCode: 'OTHER-CODE', courseName: 'Other', type: 'all' }] })
      )
    ).toBe(false);
  });
});
