...
import { Clock, MapPin, Users, CircleCheck, RotateCcw, Zap } from 'lucide-react';
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                        <div className="flex items-center gap-2 min-w-[120px] bg-warning/10 px-2 py-1 rounded-md">
                            <div className="flex flex-col">
                                <span className="text-xs font-medium text-warning">{t('exams.opening')} {formatCountdown(msRemaining)}</span>
                                <span className="text-[10px] text-warning/70">{term.registrationStart}</span>
                            </div>
                        </div>
