...
export const MOCK_MAP_EVENTS: MapEvent[] = [
  {
    id: 'mock-0',
    title: 'Erasmus Cup: Basketball',
    url: 'https://www.instagram.com/esnmendelubrno/',
    date: '2026-07-10',
    endDate: null,
    time: '18:00',
    location: 'Sportovní centrum',
    imageUrl: null,
    organizerKey: 'mendelu',
    societyId: 'esn',
    coord: [16.588635, 49.215198],
    roomCode: null,
    venueKind: 'campus',
    category: 'sports',
  },
  {
    id: 'mock-1',
    title: 'PEF Kvíz',
    url: 'https://www.instagram.com/supefmendelu/',
    date: '2026-07-11',
    endDate: null,
    time: '18:00',
    location: 'Q01',
