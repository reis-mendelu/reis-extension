...
import type { StudyPlan, SubjectStatus, StudyStats, StudyComparison } from '../../../../types/studyPlan';
...
function stats(overrides: Partial<StudyStats> = {}): StudyStats {
    return {
        currentSemester: { enrolledCredits: 28, earnedCredits: 12, unearnedCredits: 0, completedSubjects: 2, gpa: 1.71, gpaWithFails: 1.71 },
