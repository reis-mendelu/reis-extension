...
function ClassmateChip({
  classmate,
  onOpen,
}: {
  classmate: Classmate;
  onOpen: (c: Classmate) => void;
}) {
  return (
    <div
      role="button"
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        {classmate.studyInfo && (
          <div className="text-[10px] text-base-content/40 truncate leading-tight">
            {classmate.studyInfo}
          </div>
        )}
      </div>
        ...
        <div className="mt-2 px-1">
          {classmates.length >= SEARCH_THRESHOLD && (
            <div className="relative mb-2">
              ...
              <Search
                size={12}
                className="absolute left-2 top-1/2 -translate-y-1/2 text-base-content/40 pointer-events-none"
              />
            </div>
          )}
