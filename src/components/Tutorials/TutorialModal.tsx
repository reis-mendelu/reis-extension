...
export function TutorialModal({ tutorial, isOpen, onClose }: any) {
    ...
    const key = useCallback((e: any) => { if (e.key === 'ArrowLeft') prev(); if (e.key === 'ArrowRight') next(); if (e.key === 'Escape') onClose(); }, [prev, next, onClose]);
