...
export interface MenuItem { id: string; label: string; shortLabel?: string; popupLabel?: string; icon: React.ReactNode; badge?: number; expandable?: boolean; children?: { label: string; id: string; subtitle?: string; icon?: React.ReactNode; href?: string; isFeature?: boolean; isSubject?: boolean; courseCode?: string; subjectId?: string; isPinned?: boolean; }[]; danger?: boolean; onClick?: () => void; href?: string; isFeature?: boolean; }

export const getMainMenuItems = (sid: string = '', oid: string = '', t: (key: string) => string, lang: string = 'cz', pinnedPages: PinnedPage[] = []): MenuItem[] => mainItems(sid, oid, t, lang, pinnedPages);
