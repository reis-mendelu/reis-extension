    ...
    <div className="space-y-4 pt-1 pb-4">
      ...
      <div className="flex flex-wrap gap-2 items-end">
        <div className="flex flex-col gap-1.5 flex-1 min-w-[140px]">
          <span className="text-[10px] uppercase font-bold text-base-content/30 ml-1">
            {t('timeline.type')}
          </span>
          <DropdownMenu>
      ...
      {deadlines.length > 0 && (
        <div className="grid grid-cols-1 gap-2 pt-1">
          {deadlines.map((d, i) => (
            <div
              key={i}
              className="flex items-center justify-between bg-base-200/40 px-3 py-2 rounded-lg group text-sm border border-transparent hover:border-base-300 transition-all"
            >
