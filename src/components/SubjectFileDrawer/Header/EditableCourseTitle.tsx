...
export function EditableCourseTitle({
  ...
  if (isEditing) {
    ...
    return (
      <div
        className="flex items-center gap-2 mt-1 mb-1 relative max-w-xs w-full"
        data-edit-container
      >
        <input
          ref={inputRef}
    ...
    <div className="flex items-start gap-2 group max-w-full">
      <div className="flex items-center gap-2 overflow-hidden">
        {courseId ? (
          ...
          <span className="text-lg sm:text-xl font-bold text-base-content truncate">
            {displayName || defaultName}
          </span>
        )}
      </div>
