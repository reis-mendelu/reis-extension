        ...
        <div className="card bg-base-100 shadow-xl border border-base-300 fixed bottom-2 right-2 z-[9999] w-80">
            <div className="card-body p-3 gap-2">
                <div className="flex items-center justify-between">
                    <span className="font-semibold text-sm">Google Drive · Phase 0</span>
                ...
                <div className="grid grid-cols-2 gap-1">
                    ...
                    <button
                        disabled={busy}
                        onClick={run('upload test', () =>
                            uploadFile(
                                `reis-test-${Date.now()}.txt`,
                                new Blob([`reIS Drive test — ${new Date().toISOString()}`], {
                                    type: 'text/plain',
                                }),
                            ),
                        )}
