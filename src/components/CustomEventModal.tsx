...
export function CustomEventModal({
  ...
  const timeCls =
    'w-[104px] bg-base-200 rounded-lg px-2 py-1.5 text-sm border-none outline-none focus:ring-1 focus:ring-primary/40 focus:bg-base-300 transition-all tabular-nums';
