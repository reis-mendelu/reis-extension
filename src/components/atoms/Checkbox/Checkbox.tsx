  ...
  return (
    <div
      ...
      className={cn(
        ...
        sizeClasses,
        isActive ? 'bg-primary border-primary' : 'bg-base-100 border-base-300 hover:border-primary',
        className
      )}
    >
      ...
      {indeterminate && <Minus size={iconSize} className="text-primary-content" strokeWidth={3} />}
    </div>
  );
}
