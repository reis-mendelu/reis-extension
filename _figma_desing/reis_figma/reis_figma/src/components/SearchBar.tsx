import { Search, ArrowLeft, ArrowRight, User, FileText, X, ChevronUp, ChevronDown, Clock } from 'lucide-react';
      ...
      <div className="flex-1 max-w-2xl mx-auto flex items-center gap-2">
        ...
        >
          ...
          <div className={`
            ...
            ${isOpen 
              ? 'rounded-t-lg rounded-b-none border-b-gray-100 shadow-lg' 
                ...
                {displayResults.length > 0 ? (
                  displayResults.map((result, index) => (
                    <button
                      ...
                      className={`w-full px-4 py-2.5 flex items-center gap-3 cursor-pointer transition-colors text-left ${
                        selectedIndex === index ? 'bg-[#8DC843]/10' : 'hover:bg-gray-50'
                      }`}
                    >
                      {/* Left Icon Container */}
